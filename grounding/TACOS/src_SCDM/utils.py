...
def scdm_relu_conv(image, sentence_fts, is_training, input_filters, output_filters, kernel_h, kernel_w, strides, num_id):
    with tf.variable_scope('scdm_relu_conv'+str(num_id)) as scope:
...
def scm_relu_conv(image,sentence_fts,is_training,input_filters, output_filters, kernel_h,kernel_w, strides,num_id):
    with tf.variable_scope('scm_relu_conv'+str(num_id)) as scope:
